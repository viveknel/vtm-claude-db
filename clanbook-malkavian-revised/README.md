# Clanbook: Malkavian (Revised) — Searchable Index Bundle
...
Book: *Clanbook: Malkavian (Revised)* — 106 pages, indexed 2026-08-15.
...
2. For precise facts, exact numbers, or verifying a quote, query the
   ...
   python3 scripts/query_chunks.py book_chunks.db --chapter "Chapter One: The Tower of Babel"
   ```
