# Clanbook: Salubri — Searchable Index Bundle
...
Book: *Clanbook: Salubri* (for *Vampire: The Dark Ages*) — 74 pages,
indexed 2026-08-15.

Note: this is a **Dark Ages**-line sourcebook, not a V20 book. It's
included in this library alongside the V20 core/lore books and the
`v20-dark-ages` sourcebook — see the top-level `README.md` for how the
different game lines/editions in this library relate to each other.
...
2. For precise facts, exact numbers, or verifying a quote, query the
   ...
   python3 scripts/query_chunks.py book_chunks.db --chapter "Chapter Two: The Triumvirate"
   ```
