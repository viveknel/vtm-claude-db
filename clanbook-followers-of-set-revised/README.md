# Clanbook: Followers of Set (Revised) — Searchable Index Bundle
...
Book: *Clanbook: Followers of Set (Revised)* — 106 pages, indexed 2026-08-15.
...
2. For precise facts, exact numbers, or verifying a quote, query the
   ...
   python3 scripts/query_chunks.py book_chunks.db --chapter "Chapter One: A History of Lies"
   ```
