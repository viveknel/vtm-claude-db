# Vampire: The Masquerade 20th Anniversary Edition — Searchable Index Bundle
...
Book: Vampire: The Masquerade 20th Anniversary Edition (core rulebook)
— 528 pages, indexed 2026-08-15.
...
2. For precise facts, exact numbers, or verifying a quote, query the
   ...
   python3 scripts/query_chunks.py book_chunks.db --chapter "Chapter Seven: Morality"
   ```
...
Note: Chapters Three through Six and Eight are primarily game mechanics
