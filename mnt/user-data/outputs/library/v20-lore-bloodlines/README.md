# V20 Lore of the Bloodlines — Searchable Index Bundle
...
Book: Vampire: The Masquerade 20th Anniversary Edition — Lore of the
Bloodlines — 103 pages, indexed 2026-08-15.
...
2. For precise facts, exact numbers, or verifying a quote, query the
   ...
   python3 scripts/query_chunks.py book_chunks.db --chapter "Baali"
   ```
